...
//             Menu
//           </div>
//           <Menu theme="dark" mode="inline" defaultSelectedKeys={["1"]} onClick={(e) => setSelectedKey(e.key)}>
//             <Menu.Item key="1" icon={<HomeOutlined />}>
//               Home
//             </Menu.Item>
//             <Menu.SubMenu
//               key="2" icon={<DashboardOutlined />} title="Dashboard">
...
//               <Avatar
//                 style={{ backgroundColor: "#87d068", marginLeft: "12px" }} icon={<UserOutlined />}/>
//               {user ? (
